...
{
	if (region.V.z === region.ag.z)
	{
		return 'on line ' + region.V.z;
	}
	return 'on lines ' + region.V.z + ' through ' + region.ag.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aq, request.J, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {am: fragment, aY: host, a6: path, a7: port_, a8: protocol, F: query};
	});
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ah: error, ai: errorDescription, aj: errorUri, W: state};
	});
...
var $author$project$OAuth$AuthorizationCode$defaultParsers = {L: $author$project$OAuth$AuthorizationCode$defaultAuthorizationErrorParser, M: $author$project$OAuth$AuthorizationCode$defaultAuthorizationSuccessParser, O: $author$project$OAuth$AuthorizationCode$defaultCodeParser, P: $author$project$OAuth$AuthorizationCode$defaultErrorParser};
...
var $author$project$OAuth$AuthorizationCode$parseCodeWith = F2(
	function (_v0, url_) {
		var codeParser = _v0.O;
		var errorParser = _v0.P;
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{am: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
		...
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{a: $author$project$Main$Idle, ay: redirectUri},
			...
			case 2:
				...
				if (mflags.$ === 1) {
					...
					return (!_Utils_eq(
						state,
						$elm$core$Maybe$Just(flags.W))) ? _Utils_Tuple2(
						{
							a: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							ay: redirectUri
						},
						...
						{
							a: $author$project$Main$Authorized(code),
							ay: redirectUri
						},
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {as: name, au: picture};
	});
var $author$project$Main$defaultHttpsUrl = {am: $elm$core$Maybe$Nothing, aY: '', a6: '', a7: $elm$core$Maybe$Nothing, a8: 1, F: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	K: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aY: 'elm-oauth2.eu.auth0.com', a6: '/authorize'}),
	N: 'AbRrXEIRBPgkDrqR4RgdXuHoAd1mDetT',
	T: _List_fromArray(
		['openid', 'profile']),
	Y: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aY: 'elm-oauth2.eu.auth0.com', a6: '/oauth/token'}),
	Z: A3(
	...
	_: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aY: 'elm-oauth2.eu.auth0.com', a6: '/userinfo'})
};
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.a8),
				'://',
				url.aY,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Internal$AuthenticationSuccess = F4(
	function (token, refreshToken, expiresIn, scope) {
		return {aV: expiresIn, ba: refreshToken, T: scope, bi: token};
	});
...
var $author$project$Internal$makeRequest = F4(
	function (toMsg, url, headers, body) {
		return {
			ab: A2($elm$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			al: A2($elm$http$Http$expectJson, toMsg, $author$project$Internal$authenticationSuccessDecoder),
			an: headers,
			aq: 'POST',
...
var $author$project$OAuth$AuthorizationCode$makeTokenRequest = F2(
	function (toMsg, _v0) {
		var credentials = _v0.aS;
		var code = _v0.ad;
		var url = _v0.J;
		var redirectUri = _v0.ay;
		var headers = $author$project$Internal$makeHeaders(
			function () {
				var _v1 = credentials.bc;
				if (_v1.$ === 1) {
					return $elm$core$Maybe$Nothing;
				} else {
					var secret = _v1.a;
					return $elm$core$Maybe$Just(
						{N: credentials.N, bc: secret});
				}
			}());
		var body = A2(
			...
			$elm$url$Url$Builder$toQuery(
				_List_fromArray(
					[
						...
						A2($elm$url$Url$Builder$string, 'client_id', credentials.N),
						A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aO: false, ab: r.ab, al: r.al, an: r.an, aq: r.aq, aH: r.aH, aI: r.aI, J: r.J}));
};
var $author$project$Main$getAccessToken = F3(
	function (_v0, redirectUri, code) {
		var clientId = _v0.N;
		var tokenEndpoint = _v0.Y;
		return $elm$http$Http$request(
			A2(
				...
				{
					ad: code,
					aS: {N: clientId, bc: $elm$core$Maybe$Nothing},
					ay: redirectUri,
					J: tokenEndpoint
				}));
	});
var $author$project$Main$accessTokenRequested = F2(
	function (model, code) {
		return _Utils_Tuple2(
			...
			A3($author$project$Main$getAccessToken, $author$project$Main$configuration, model.ay, code));
	});
...
var $author$project$Main$ErrHTTPGetAccessToken = {$: 3};
...
var $author$project$Internal$AuthenticationError = F3(
	function (error, errorDescription, errorUri) {
		return {ah: error, ai: errorDescription, aj: errorUri};
	});
...
var $author$project$Main$gotAccessToken = F2(
	function (model, authenticationResponse) {
		if (authenticationResponse.$ === 1) {
			...
			var token = authenticationResponse.a.bi;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
...
var $author$project$OAuth$AuthorizationCode$makeAuthorizationUrl = function (_v0) {
	...
	return A2(
		...
		0,
		{N: clientId, ae: $elm$core$Maybe$Nothing, ay: redirectUri, T: scope, W: state, J: url});
};
var $author$project$Main$gotRandomBytes = F2(
	function (model, bytes) {
		...
		var authorization = {
			...
			ay: model.ay,
			T: $author$project$Main$configuration.T,
			W: $elm$core$Maybe$Just(state),
...
var $author$project$Main$ErrHTTPGetUserInfo = {$: 4};
...
var $author$project$Main$getUserInfo = F2(
	function (_v0, token) {
		var userInfoDecoder = _v0.Z;
		var userInfoEndpoint = _v0._;
		return $elm$http$Http$request(
			{
				ab: $elm$http$Http$emptyBody,
				al: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				an: A2($author$project$OAuth$useToken, token, _List_Nil),
				aq: 'GET',
				aH: $elm$core$Maybe$Nothing,
				aI: $elm$core$Maybe$Nothing,
...
var $author$project$Main$view = F2(
	function (config, model) {
		var title = config.I;
		return {
			ab: A2($author$project$Main$viewBody, config, model),
			I: title
		};
	});
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		a3: $elm$core$Basics$always($author$project$Main$NoOp),
		...
		bk: $author$project$Main$view(
			{
				...
				I: 'Auth0 - Flow: Authorization Code'
			})
	});
