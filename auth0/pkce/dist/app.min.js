...
{
	if (region.W.z === region.ah.z)
	{
		return 'on line ' + region.W.z;
	}
	return 'on lines ' + region.W.z + ' through ' + region.ah.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ar, request.K, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {an: fragment, aZ: host, a7: path, a8: port_, a9: protocol, G: query};
	});
...
var $author$project$Main$cCODE_VERIFIER_SIZE = 32;
var $author$project$Main$cSTATE_SIZE = 8;
var $author$project$OAuth$AuthorizationCode$PKCE$CodeVerifier = $elm$core$Basics$identity;
var $author$project$OAuth$AuthorizationCode$PKCE$codeVerifierFromBytes = function (bytes) {
...
var $author$project$Main$convertBytes = function (bytes) {
	if (_Utils_cmp(
		$elm$core$List$length(bytes),
		$author$project$Main$cSTATE_SIZE + $author$project$Main$cCODE_VERIFIER_SIZE) < 0) {
		return $elm$core$Maybe$Nothing;
	} else {
		var state = $author$project$Main$base64(
			$author$project$Main$toBytes(
				A2($elm$core$List$take, $author$project$Main$cSTATE_SIZE, bytes)));
		var mCodeVerifier = $author$project$OAuth$AuthorizationCode$PKCE$codeVerifierFromBytes(
			$author$project$Main$toBytes(
				A2($elm$core$List$drop, $author$project$Main$cSTATE_SIZE, bytes)));
		return A2(
			$elm$core$Maybe$map,
			function (codeVerifier) {
				return {F: codeVerifier, X: state};
			},
			mCodeVerifier);
	}
};
var $author$project$Main$AccessTokenRequested = {$: 3};
var $author$project$Main$Authorized = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $author$project$Main$ErrStateMismatch = {$: 0};
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ai: error, aj: errorDescription, ak: errorUri, X: state};
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthorizationErrorParser = $author$project$Internal$authorizationErrorParser;
var $author$project$OAuth$AuthorizationCode$PKCE$AuthorizationSuccess = F2(
	function (code, state) {
		return {ae: code, X: state};
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthorizationSuccessParser = function (code) {
	return A2(
		$elm$url$Url$Parser$Query$map,
		$author$project$OAuth$AuthorizationCode$PKCE$AuthorizationSuccess(code),
		$author$project$Internal$stateParser);
};
var $author$project$OAuth$AuthorizationCode$PKCE$defaultCodeParser = $elm$url$Url$Parser$Query$string('code');
...
var $author$project$OAuth$AuthorizationCode$PKCE$defaultErrorParser = $author$project$Internal$errorParser($author$project$OAuth$errorCodeFromString);
var $author$project$OAuth$AuthorizationCode$PKCE$defaultParsers = {M: $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthorizationErrorParser, N: $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthorizationSuccessParser, P: $author$project$OAuth$AuthorizationCode$PKCE$defaultCodeParser, Q: $author$project$OAuth$AuthorizationCode$PKCE$defaultErrorParser};
var $author$project$OAuth$AuthorizationCode$PKCE$Empty = {$: 0};
var $author$project$OAuth$AuthorizationCode$PKCE$Error = function (a) {
	return {$: 1, a: a};
};
var $author$project$OAuth$AuthorizationCode$PKCE$Success = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$OAuth$AuthorizationCode$PKCE$parseCodeWith = F2(
	function (_v0, url_) {
		var codeParser = _v0.P;
		var errorParser = _v0.Q;
		var authorizationSuccessParser = _v0.N;
		var authorizationErrorParser = _v0.M;
			...
			if (!_v1.$) {
				if (!_v1.a.a.$) {
					...
					return A3(
						...
						url,
						$author$project$OAuth$AuthorizationCode$PKCE$Empty,
						A2(
							$elm$url$Url$Parser$Query$map,
							$author$project$OAuth$AuthorizationCode$PKCE$Success,
					...
					if (!_v1.a.b.$) {
						...
						return A3(
							...
							A2(
								$elm$url$Url$Parser$Query$map,
								$author$project$OAuth$AuthorizationCode$PKCE$Error,
		...
		return $author$project$OAuth$AuthorizationCode$PKCE$Empty;
	});
var $author$project$OAuth$AuthorizationCode$PKCE$parseCode = $author$project$OAuth$AuthorizationCode$PKCE$parseCodeWith($author$project$OAuth$AuthorizationCode$PKCE$defaultParsers);
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{an: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
			$elm$browser$Browser$Navigation$replaceUrl,
			navigationKey,
			$elm$url$Url$toString(redirectUri));
		var _v0 = $author$project$OAuth$AuthorizationCode$PKCE$parseCode(origin);
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{a: $author$project$Main$Idle, az: redirectUri},
			...
			case 2:
				...
				if (mflags.$ === 1) {
					return _Utils_Tuple2(
						{
							a: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							az: redirectUri
						},
						clearUrl);
				} else {
					...
					return (!_Utils_eq(
						state,
						$elm$core$Maybe$Just(flags.X))) ? _Utils_Tuple2(
						{
							a: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							az: redirectUri
						},
						...
						{
							a: A2($author$project$Main$Authorized, code, flags.F),
							az: redirectUri
						},
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A3($andrewMacmurray$elm_delay$Delay$after, 750, 0, $author$project$Main$AccessTokenRequested),
									clearUrl
								])));
				}
			default:
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {at: name, av: picture};
	});
var $author$project$Main$defaultHttpsUrl = {an: $elm$core$Maybe$Nothing, aZ: '', a7: '', a8: $elm$core$Maybe$Nothing, a9: 1, G: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	L: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aZ: 'elm-oauth2.eu.auth0.com', a7: '/authorize'}),
	O: 'AbRrXEIRBPgkDrqR4RgdXuHoAd1mDetT',
	U: _List_fromArray(
		['openid', 'profile']),
	Z: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aZ: 'elm-oauth2.eu.auth0.com', a7: '/oauth/token'}),
	_: A3(
	...
	aa: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aZ: 'elm-oauth2.eu.auth0.com', a7: '/userinfo'})
};
...
var $author$project$OAuth$AuthorizationCode$PKCE$base64UrlEncode = A2(
	$elm$core$Basics$composeR,
...
var $author$project$OAuth$AuthorizationCode$PKCE$codeVerifierToString = function (_v0) {
	var str = _v0;
	return $author$project$OAuth$AuthorizationCode$PKCE$base64UrlEncode(str);
};
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.a9),
				'://',
				url.aZ,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Internal$AuthenticationSuccess = F4(
	function (token, refreshToken, expiresIn, scope) {
		return {aW: expiresIn, bb: refreshToken, U: scope, bj: token};
	});
...
var $author$project$Extra$Maybe$andThen2 = F3(
	function (fn, ma, mb) {
		return A2(
...
var $author$project$Internal$makeRequest = F4(
	function (toMsg, url, headers, body) {
		return {
			ac: A2($elm$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			am: A2($elm$http$Http$expectJson, toMsg, $author$project$Internal$authenticationSuccessDecoder),
			ao: headers,
			ar: 'POST',
			aI: $elm$core$Maybe$Nothing,
			aJ: $elm$core$Maybe$Nothing,
			K: $elm$url$Url$toString(url)
		};
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$makeTokenRequest = F2(
	function (toMsg, _v0) {
		var credentials = _v0.aT;
		var code = _v0.ae;
		var codeVerifier = _v0.F;
		var url = _v0.K;
		var redirectUri = _v0.az;
		var headers = $author$project$Internal$makeHeaders(
			function () {
				var _v1 = credentials.bd;
				if (_v1.$ === 1) {
					return $elm$core$Maybe$Nothing;
				} else {
					var secret = _v1.a;
					return $elm$core$Maybe$Just(
						{O: credentials.O, bd: secret});
				}
			}());
		var body = A2(
			...
			$elm$url$Url$Builder$toQuery(
				_List_fromArray(
					[
						...
						$elm$url$Url$Builder$string,
						'code_verifier',
						$author$project$OAuth$AuthorizationCode$PKCE$codeVerifierToString(codeVerifier))
					])));
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aP: false, ac: r.ac, am: r.am, ao: r.ao, ar: r.ar, aI: r.aI, aJ: r.aJ, K: r.K}));
};
var $author$project$Main$getAccessToken = F4(
	function (_v0, redirectUri, code, codeVerifier) {
		var clientId = _v0.O;
		var tokenEndpoint = _v0.Z;
		return $elm$http$Http$request(
			A2(
				$author$project$OAuth$AuthorizationCode$PKCE$makeTokenRequest,
				$author$project$Main$GotAccessToken,
				{
					ae: code,
					F: codeVerifier,
					aT: {O: clientId, bd: $elm$core$Maybe$Nothing},
					az: redirectUri,
					K: tokenEndpoint
				}));
	});
var $author$project$Main$accessTokenRequested = F3(
	function (model, code, codeVerifier) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					a: A2($author$project$Main$Authorized, code, codeVerifier)
				}),
			A4($author$project$Main$getAccessToken, $author$project$Main$configuration, model.az, code, codeVerifier));
	});
...
var $author$project$Main$ErrHTTPGetAccessToken = {$: 4};
var $author$project$Main$UserInfoRequested = {$: 5};
var $author$project$Internal$AuthenticationError = F3(
	function (error, errorDescription, errorUri) {
		return {ai: error, aj: errorDescription, ak: errorUri};
	});
...
var $author$project$OAuth$AuthorizationCode$PKCE$defaultErrorDecoder = $author$project$Internal$errorDecoder($author$project$OAuth$errorCodeFromString);
var $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthenticationErrorDecoder = $author$project$Internal$authenticationErrorDecoder($author$project$OAuth$AuthorizationCode$PKCE$defaultErrorDecoder);
var $author$project$Main$gotAccessToken = F2(
	function (model, authenticationResponse) {
		if (authenticationResponse.$ === 1) {
			if (authenticationResponse.a.$ === 4) {
				var body = authenticationResponse.a.a;
				var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$OAuth$AuthorizationCode$PKCE$defaultAuthenticationErrorDecoder, body);
				if (!_v1.$) {
					var error = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								a: $author$project$Main$Errored($author$project$Main$ErrHTTPGetAccessToken)
							}),
						$elm$core$Platform$Cmd$none);
				}
			} else {
			...
			var token = authenticationResponse.a.bj;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						a: $author$project$Main$Authenticated(token)
					}),
				A3($andrewMacmurray$elm_delay$Delay$after, 750, 0, $author$project$Main$UserInfoRequested));
		}
	});
var $author$project$Main$ErrFailedToConvertBytes = {$: 1};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Internal$Code = 0;
var $author$project$OAuth$AuthorizationCode$PKCE$codeChallengeToString = function (_v0) {
	var str = _v0;
	return $author$project$OAuth$AuthorizationCode$PKCE$base64UrlEncode(str);
};
...
var $author$project$Internal$makeAuthorizationUrl = F2(
...
var $author$project$OAuth$AuthorizationCode$PKCE$makeAuthorizationUrl = function (_v0) {
	var clientId = _v0.O;
	var url = _v0.K;
	var redirectUri = _v0.az;
	var scope = _v0.U;
	...
	var codeChallenge = _v0.af;
	return A2(
		$author$project$Internal$makeAuthorizationUrl,
		0,
		{
			O: clientId,
			af: $elm$core$Maybe$Just(
				$author$project$OAuth$AuthorizationCode$PKCE$codeChallengeToString(codeChallenge)),
			az: redirectUri,
			U: scope,
			X: state,
			K: url
...
var $author$project$OAuth$AuthorizationCode$PKCE$CodeChallenge = $elm$core$Basics$identity;
var $elm$core$Basics$composeL = F3(
	function (g, f, x) {
		return g(
			f(x));
	});
var $folkertdev$elm_sha2$Internal$SHA256$Digest = $elm$core$Basics$identity;
...
var $folkertdev$elm_sha2$Internal$SHA256$DeltaState = $elm$core$Basics$identity;
var $folkertdev$elm_sha2$Internal$SHA256$State = $elm$core$Basics$identity;
														...
														return function (b3) {
															return function (b2) {
																return function (b1) {
																													...
																													A3(
																														...
																														A3(
																															...
																															A3(
																																...
																																1,
																																b2,
																																A3($folkertdev$elm_sha2$Internal$SHA256$calculateDigestDeltas, 0, b1, initial))))))))))))))));
																	...
																	var g = _v2.g;
																	var h = _v2.h;
																	return A8($folkertdev$elm_sha2$Internal$SHA256$Tuple8, h0 + a, h1 + b, h2 + c, h3 + d, h4 + e, h5 + f, h6 + g, h7 + h);
																};
															};
														};
													};
...
var $folkertdev$elm_sha2$Internal$SHA256$u32 = $elm$bytes$Bytes$Decode$unsignedInt32(1);
...
var $folkertdev$elm_sha2$Internal$SHA256$hashBytes = F2(
	function (state, bytes) {
		...
		var g = _v1.g;
		var h = _v1.h;
		return A8($folkertdev$elm_sha2$Internal$SHA256$Tuple8, a >>> 0, b >>> 0, c >>> 0, d >>> 0, e >>> 0, f >>> 0, g >>> 0, h >>> 0);
	});
...
var $folkertdev$elm_sha2$SHA256$initialState = A8($folkertdev$elm_sha2$Internal$SHA256$Tuple8, 1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225);
	...
	return $elm$bytes$Bytes$Encode$sequence(
		_List_fromArray(
			[
				...
				A2($elm$bytes$Bytes$Encode$unsignedInt32, 1, e),
				A2($elm$bytes$Bytes$Encode$unsignedInt32, 1, f),
				A2($elm$bytes$Bytes$Encode$unsignedInt32, 1, g),
				A2($elm$bytes$Bytes$Encode$unsignedInt32, 1, h)
			]));
};
...
var $author$project$OAuth$AuthorizationCode$PKCE$mkCodeChallenge = A2(
	$elm$core$Basics$composeR,
	$author$project$OAuth$AuthorizationCode$PKCE$codeVerifierToString,
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2($elm$core$Basics$composeR, $chelovek0v$bbase64$Base64$Encode$bytes, $elm$core$Basics$identity))));
		...
		if (_v0.$ === 1) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						a: $author$project$Main$Errored($author$project$Main$ErrFailedToConvertBytes)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var state = _v0.a.X;
			var codeVerifier = _v0.a.F;
			var authorization = {
				O: $author$project$Main$configuration.O,
				af: $author$project$OAuth$AuthorizationCode$PKCE$mkCodeChallenge(codeVerifier),
				az: model.az,
				U: $author$project$Main$configuration.U,
				X: $elm$core$Maybe$Just(state),
				K: $author$project$Main$configuration.L
			};
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{a: $author$project$Main$Idle}),
				$elm$browser$Browser$Navigation$load(
					$elm$url$Url$toString(
						$author$project$OAuth$AuthorizationCode$PKCE$makeAuthorizationUrl(authorization))));
		}
	});
var $author$project$Main$Done = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$ErrHTTPGetUserInfo = {$: 5};
var $author$project$Main$gotUserInfo = F2(
	function (model, userInfoResponse) {
		if (userInfoResponse.$ === 1) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						a: $author$project$Main$Errored($author$project$Main$ErrHTTPGetUserInfo)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						a: $author$project$Main$Done(userInfo)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$signInRequested = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{a: $author$project$Main$Idle}),
		$author$project$Main$genRandomBytes($author$project$Main$cSTATE_SIZE + $author$project$Main$cCODE_VERIFIER_SIZE));
};
...
var $author$project$Main$getUserInfo = F2(
	function (_v0, token) {
		var userInfoDecoder = _v0._;
		var userInfoEndpoint = _v0.aa;
		return $elm$http$Http$request(
			{
				ac: $elm$http$Http$emptyBody,
				am: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				ao: A2($author$project$OAuth$useToken, token, _List_Nil),
				ar: 'GET',
				aI: $elm$core$Maybe$Nothing,
				aJ: $elm$core$Maybe$Nothing,
				K: $elm$url$Url$toString(userInfoEndpoint)
			});
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(model.a, msg);
		_v0$7:
		while (true) {
			switch (_v0.a.$) {
				case 0:
				...
				case 1:
					switch (_v0.b.$) {
						case 3:
							...
							var _v5 = _v0.b;
							return A3($author$project$Main$accessTokenRequested, model, code, codeVerifier);
						case 4:
							var _v6 = _v0.a;
...
var $author$project$Main$oauthErrorToString = function (_v0) {
	var error = _v0.ai;
	var errorDescription = _v0.aj;
	var desc = A3(
		$elm$core$String$replace,
		'+',
		' ',
		A2($elm$core$Maybe$withDefault, '', errorDescription));
	return $author$project$OAuth$errorCodeToString(error) + (': ' + desc);
};
...
var $author$project$Main$SignInRequested = {$: 1};
...
var $author$project$Main$SignOutRequested = {$: 7};
...
var $author$project$Main$view = F2(
	function (config, model) {
		var title = config.J;
		return {
			ac: A2($author$project$Main$viewBody, config, model),
			J: title
		};
	});
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		a0: A2(
			$elm$core$Basics$composeR,
			$elm$core$Maybe$andThen($author$project$Main$convertBytes),
			$author$project$Main$init),
		a4: $elm$core$Basics$always($author$project$Main$NoOp),
		a5: $elm$core$Basics$always($author$project$Main$NoOp),
		...
		bl: $author$project$Main$view(
			{
				E: $elm$html$Html$Attributes$class('btn-auth0'),
				J: 'Auth0 - Flow: Authorization Code w/ PKCE'
			})
	});
