...
{
	if (region.S.A === region.ab.A)
	{
		return 'on line ' + region.S.A;
	}
	return 'on lines ' + region.S.A + ' through ' + region.ab.A;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {z: fragment, aU: host, a2: path, a3: port_, a4: protocol, G: query};
	});
...
var $author$project$OAuth$Implicit$parseTokenWith = F2(
	function (_v0, url_) {
		var tokenParser = _v0.bf;
		var errorParser = _v0.aQ;
		var authorizationSuccessParser = _v0.aL;
		var authorizationErrorParser = _v0.aK;
		var url = _Utils_update(
			url_,
			{z: $elm$core$Maybe$Nothing, a2: '/', G: url_.z});
		var _v1 = A2(
			$elm$url$Url$Parser$parse,
			A2(
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ac: error, ad: errorDescription, ae: errorUri, T: state};
	});
...
var $author$project$OAuth$Implicit$AuthorizationSuccess = F5(
	function (token, refreshToken, expiresIn, scope, state) {
		return {aR: expiresIn, a6: refreshToken, Q: scope, T: state, be: token};
	});
...
var $author$project$Main$errorParser = A2(
	$elm$url$Url$Parser$Query$map,
	$elm$core$Maybe$map($author$project$OAuth$errorCodeFromString),
	$elm$url$Url$Parser$Query$string('error_code'));
...
var $author$project$Main$tokenParser = A2(
	$elm$url$Url$Parser$Query$map,
	$author$project$OAuth$makeToken(
		$elm$core$Maybe$Just('Bearer')),
	$elm$url$Url$Parser$Query$string('access_token'));
var $author$project$Main$parsers = {aK: $author$project$OAuth$Implicit$defaultAuthorizationErrorParser, aL: $author$project$OAuth$Implicit$defaultAuthorizationSuccessParser, aQ: $author$project$Main$errorParser, bf: $author$project$Main$tokenParser};
var $author$project$Main$patchUrl = function (url) {
	return (_Utils_eq(
		url.z,
		$elm$core$Maybe$Just('_=_')) || _Utils_eq(url.z, $elm$core$Maybe$Nothing)) ? _Utils_update(
		url,
		{z: url.G}) : url;
};
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		...
		var _v0 = A2(
			$author$project$OAuth$Implicit$parseTokenWith,
			$author$project$Main$parsers,
			$author$project$Main$patchUrl(origin));
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{e: $author$project$Main$Idle, as: redirectUri},
			...
			case 2:
				...
				if (mflags.$ === 1) {
					...
					return (!_Utils_eq(
						state,
						$elm$core$Maybe$Just(flags.T))) ? _Utils_Tuple2(
						{
							e: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							as: redirectUri
						},
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {am: name, ao: picture};
	});
var $author$project$Main$defaultHttpsUrl = {z: $elm$core$Maybe$Nothing, aU: '', a2: '', a3: $elm$core$Maybe$Nothing, a4: 1, G: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	L: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aU: 'facebook.com', a2: '/v6.0/dialog/oauth'}),
	M: '179456896198275',
	Q: _List_fromArray(
		['public_profile']),
	V: A3(
	...
	W: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{
			aU: 'graph.facebook.com',
			a2: '/v6.0/me',
			G: $elm$core$Maybe$Just('fields=name,picture.type(large)')
		})
};
...
var $author$project$Internal$makeRedirectUri = function (url) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$author$project$Internal$protocolToString(url.a4),
				'://',
				url.aU,
				A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Internal$makeAuthorizationUrl = F2(
	function (responseType, _v0) {
		var clientId = _v0.M;
		var url = _v0.K;
		var redirectUri = _v0.as;
		var scope = _v0.Q;
		var state = _v0.T;
		var codeChallenge = _v0._;
		var query = A2(
...
var $author$project$OAuth$Implicit$makeAuthorizationUrl = function (_v0) {
	...
	return A2(
		...
		1,
		{M: clientId, _: $elm$core$Maybe$Nothing, as: redirectUri, Q: scope, T: state, K: url});
};
var $author$project$Main$gotRandomBytes = F2(
	function (model, bytes) {
		...
		var state = _v0.T;
		var authorization = {
			M: $author$project$Main$configuration.M,
			as: model.as,
			Q: $author$project$Main$configuration.Q,
			T: $elm$core$Maybe$Just(state),
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aI: false, Y: r.Y, ag: r.ag, ah: r.ah, ak: r.ak, aB: r.aB, aC: r.aC, K: r.K}));
};
...
var $author$project$Main$getUserInfo = F2(
	function (_v0, token) {
		var userInfoDecoder = _v0.V;
		var userInfoEndpoint = _v0.W;
		return $elm$http$Http$request(
			{
				Y: $elm$http$Http$emptyBody,
				ag: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				ah: A2($author$project$OAuth$useToken, token, _List_Nil),
				ak: 'GET',
...
var $author$project$Main$view = F2(
	function (config, model) {
		var title = config.J;
		return {
			Y: A2($author$project$Main$viewBody, config, model),
			J: title
		};
	});
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		a$: $elm$core$Basics$always($author$project$Main$NoOp),
		...
		bh: $author$project$Main$view(
			{
				F: $elm$html$Html$Attributes$class('btn-facebook'),
				J: 'Facebook - Flow: Implicit'
			})
	});
