...
{
	if (region.U.z === region.ae.z)
	{
		return 'on line ' + region.U.z;
	}
	return 'on lines ' + region.U.z + ' through ' + region.ae.z;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.ao, request.J, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ak: fragment, aV: host, a3: path, a4: port_, a5: protocol, F: query};
	});
...
var $author$project$Main$UserInfoRequested = {$: 4};
...
var $author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {af: error, ag: errorDescription, ah: errorUri, V: state};
	});
...
var $author$project$OAuth$Implicit$defaultAuthorizationErrorParser = $author$project$Internal$authorizationErrorParser;
var $author$project$OAuth$Implicit$AuthorizationSuccess = F5(
	function (token, refreshToken, expiresIn, scope, state) {
		return {aS: expiresIn, a7: refreshToken, S: scope, V: state, bf: token};
	});
...
var $author$project$Internal$expiresInParser = $elm$url$Url$Parser$Query$int('expires_in');
...
var $author$project$Internal$spaceSeparatedListParser = function (param) {
	return A2(
...
var $author$project$Internal$scopeParser = $author$project$Internal$spaceSeparatedListParser('scope');
var $author$project$OAuth$Implicit$defaultAuthorizationSuccessParser = function (accessToken) {
	return A4(
		$elm$url$Url$Parser$Query$map3,
		A2($author$project$OAuth$Implicit$AuthorizationSuccess, accessToken, $elm$core$Maybe$Nothing),
		$author$project$Internal$expiresInParser,
		$author$project$Internal$scopeParser,
		$author$project$Internal$stateParser);
};
...
var $author$project$OAuth$Implicit$defaultErrorParser = $author$project$Internal$errorParser($author$project$OAuth$errorCodeFromString);
...
var $author$project$Internal$tokenParser = A3(
...
var $author$project$OAuth$Implicit$defaultTokenParser = $author$project$Internal$tokenParser;
var $author$project$OAuth$Implicit$defaultParsers = {L: $author$project$OAuth$Implicit$defaultAuthorizationErrorParser, M: $author$project$OAuth$Implicit$defaultAuthorizationSuccessParser, O: $author$project$OAuth$Implicit$defaultErrorParser, X: $author$project$OAuth$Implicit$defaultTokenParser};
var $author$project$OAuth$Implicit$Empty = {$: 0};
var $author$project$OAuth$Implicit$Error = function (a) {
	return {$: 1, a: a};
};
var $author$project$OAuth$Implicit$Success = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$OAuth$Implicit$parseTokenWith = F2(
	function (_v0, url_) {
		var tokenParser = _v0.X;
		var errorParser = _v0.O;
		var authorizationSuccessParser = _v0.M;
		var authorizationErrorParser = _v0.L;
		var url = _Utils_update(
			url_,
			{ak: $elm$core$Maybe$Nothing, a3: '/', F: url_.ak});
		var _v1 = A2(
			$elm$url$Url$Parser$parse,
			A2(
			...
			if (!_v1.$) {
				if (!_v1.a.a.$) {
					...
					return A3(
						...
						url,
						$author$project$OAuth$Implicit$Empty,
						A2(
							$elm$url$Url$Parser$Query$map,
							$author$project$OAuth$Implicit$Success,
					...
					if (!_v1.a.b.$) {
						...
						return A3(
							...
							A2(
								$elm$url$Url$Parser$Query$map,
								$author$project$OAuth$Implicit$Error,
		...
		return $author$project$OAuth$Implicit$Empty;
	});
var $author$project$OAuth$Implicit$parseToken = $author$project$OAuth$Implicit$parseTokenWith($author$project$OAuth$Implicit$defaultParsers);
...
var $author$project$Main$init = F3(
	function (mflags, origin, navigationKey) {
		var redirectUri = _Utils_update(
			origin,
			{ak: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing});
		var clearUrl = A2(
			$elm$browser$Browser$Navigation$replaceUrl,
			navigationKey,
			$elm$url$Url$toString(redirectUri));
		var _v0 = $author$project$OAuth$Implicit$parseToken(origin);
		switch (_v0.$) {
			case 0:
				return _Utils_Tuple2(
					{e: $author$project$Main$Idle, aw: redirectUri},
			...
			case 2:
				...
				if (mflags.$ === 1) {
					return _Utils_Tuple2(
						{
							e: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							aw: redirectUri
						},
						clearUrl);
				} else {
					...
					return (!_Utils_eq(
						state,
						$elm$core$Maybe$Just(flags.V))) ? _Utils_Tuple2(
						{
							e: $author$project$Main$Errored($author$project$Main$ErrStateMismatch),
							aw: redirectUri
						},
						...
						{
							e: $author$project$Main$Authorized(token),
							aw: redirectUri
						},
...
var $author$project$Main$UserInfo = F2(
	function (name, picture) {
		return {aq: name, as: picture};
	});
var $author$project$Main$defaultHttpsUrl = {ak: $elm$core$Maybe$Nothing, aV: '', a3: '', a4: $elm$core$Maybe$Nothing, a5: 1, F: $elm$core$Maybe$Nothing};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$configuration = {
	K: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aV: 'accounts.google.com', a3: '/o/oauth2/v2/auth'}),
	N: '909608474358-fkok86ks7e83c47aq01aiit47vsoh4s0.apps.googleusercontent.com',
	S: _List_fromArray(
		['profile']),
	Y: A3(
	...
	Z: _Utils_update(
		$author$project$Main$defaultHttpsUrl,
		{aV: 'www.googleapis.com', a3: '/oauth2/v1/userinfo'})
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Internal$Token = 1;
...
var $author$project$Internal$makeAuthorizationUrl = F2(
	function (responseType, _v0) {
		var clientId = _v0.N;
		var url = _v0.J;
		var redirectUri = _v0.aw;
		var scope = _v0.S;
		var state = _v0.V;
		var codeChallenge = _v0.ac;
		var query = A2(
		...
		if (_v1.$ === 1) {
			...
			return _Utils_update(
				url,
				{
					F: $elm$core$Maybe$Just(baseQuery + ('&' + query))
				});
		}
	});
var $author$project$OAuth$Implicit$makeAuthorizationUrl = function (_v0) {
	var clientId = _v0.N;
	var url = _v0.J;
	var redirectUri = _v0.aw;
	var scope = _v0.S;
	...
	return A2(
		...
		1,
		{N: clientId, ac: $elm$core$Maybe$Nothing, aw: redirectUri, S: scope, V: state, J: url});
};
var $author$project$Main$gotRandomBytes = F2(
	function (model, bytes) {
		...
		var state = _v0.V;
		var authorization = {
			N: $author$project$Main$configuration.N,
			aw: model.aw,
			S: $author$project$Main$configuration.S,
			V: $elm$core$Maybe$Just(state),
			J: $author$project$Main$configuration.K
		};
		return _Utils_Tuple2(
			_Utils_update(
				model,
			...
			$elm$browser$Browser$Navigation$load(
				$elm$url$Url$toString(
					$author$project$OAuth$Implicit$makeAuthorizationUrl(authorization))));
	});
var $author$project$Main$Done = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$ErrHTTPGetUserInfo = {$: 2};
		...
		if (userInfoResponse.$ === 1) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						e: $author$project$Main$Errored($author$project$Main$ErrHTTPGetUserInfo)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						e: $author$project$Main$Done(userInfo)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aM: false, aa: r.aa, aj: r.aj, al: r.al, ao: r.ao, aF: r.aF, aG: r.aG, J: r.J}));
};
...
var $author$project$Main$getUserInfo = F2(
	function (_v0, token) {
		var userInfoDecoder = _v0.Y;
		var userInfoEndpoint = _v0.Z;
		return $elm$http$Http$request(
			{
				aa: $elm$http$Http$emptyBody,
				aj: A2($elm$http$Http$expectJson, $author$project$Main$GotUserInfo, userInfoDecoder),
				al: A2($author$project$OAuth$useToken, token, _List_Nil),
				ao: 'GET',
				aF: $elm$core$Maybe$Nothing,
				aG: $elm$core$Maybe$Nothing,
				J: $elm$url$Url$toString(userInfoEndpoint)
			});
	});
...
var $author$project$Main$SignOutRequested = {$: 6};
...
var $author$project$Main$view = F2(
	function (config, model) {
		var title = config.I;
		return {
			aa: A2($author$project$Main$viewBody, config, model),
			I: title
		};
	});
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		a0: $elm$core$Basics$always($author$project$Main$NoOp),
		a1: $elm$core$Basics$always($author$project$Main$NoOp),
		...
		bh: $author$project$Main$view(
			{
				E: $elm$html$Html$Attributes$class('btn-google'),
				I: 'Google - Flow: Implicit'
			})
	});
